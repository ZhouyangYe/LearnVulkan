...
namespace LearnVulkan {
	...
	void Texture::load_image_from_file(const char* file)
	{
		...
		Buffer stagingBuffer = renderer->device.create_buffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VMA_MEMORY_USAGE_CPU_ONLY);

		GPUData data{ pixel_ptr, imageSize };
		renderer->device.upload_data(stagingBuffer, data);

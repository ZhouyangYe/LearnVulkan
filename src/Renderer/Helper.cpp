...
namespace LearnVulkan {
	...
	VkPipelineVertexInputStateCreateInfo vkinit::vertex_input_state_create_info(VertexLayout& layout)
	{
		...
		info.pVertexAttributeDescriptions = layout.description.attributes.data();
		info.vertexAttributeDescriptionCount = layout.description.attributes.size();

		info.pVertexBindingDescriptions = layout.description.bindings.data();
		info.vertexBindingDescriptionCount = layout.description.bindings.size();
	...
	VkPipelineLayoutCreateInfo vkinit::pipeline_layout_create_info(std::vector<VkPushConstantRange>& constants, std::vector<VkDescriptorSetLayout>& descriptorLayouts) {
		...
		// hook the descriptor set layout
		if (descriptorLayouts.size()) {
			info.setLayoutCount = descriptorLayouts.size();
